<section class="h-full overflow-hidden overflow-y-scroll scrollbar rounded-t-lg">
    <table class="w-full">
        <thead>
            <th class="text-white bg-primary">New Account Titles</th>
            <th class="text-white bg-primary">Account Number</th>
            <th class="text-white bg-primary">Debit</th>
            <th class="text-white bg-primary">Credit</th>
        </thead>
